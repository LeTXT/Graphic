...
export const createHeightsOfHorintalLines = (n, svgHeight) => svgHeight * (.14285714285 * n)

// export const createLineX2 = (svgRef) => svgRef.clientWidth

export const createVerticalLine = (verticalLine, containerWidth, svgWidth, setInfoCard) => {
    ...
    for(let i in widthLine) {
        ...
        if(mouseHover < widthLine[0] + middle[0]) {
            ...
            return widthLine[i] + 1

        } else if(mouseHover > widthLine[i] - middle[0] && mouseHover < widthLine[i] + middle[0]) {
