...
export const createBezierCurve = (svgWidth, svgHeight) => {
    ...
    if(weekArray[0].amount[0] && svgHeight && svgWidth ) {
        ...
        for (let i in weekArray[0].amount) {
            ...
            console.log({curve: curve, svgHeight: svgHeight, maximumHeight: maximumHeight, widthLine: widthLine[i], widthCurve: widthCurve});
